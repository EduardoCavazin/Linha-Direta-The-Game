...
class Hud:
    ...
    def draw_debug_info(self, game_manager) -> None:
        ...
        debug_lines = [
            ...
            "F1 - Ativar/desativar debug e hitboxes",
            "F2 - Informações detalhadas de hitbox",
            "",
            "Cores do Debug:",
            "Verde - Jogador (hitbox triangular)",
            "Vermelho - Inimigos",
            "Amarelo - Itens",
            "Ciano - Hitboxes de portas",
            "Branco - Estruturas/paredes do mundo",
            "Laranja - Zonas de fogo e balas inimigas",
            "Magenta - Balas do jogador",
            "",
            "Estados das Portas:",
            "Vermelho preenchido - Porta trancada",
            "Azul preenchido - Porta destrancada"
        ]
